...
const PIPELINE = [
  ...
  { name: "직접 확인", detail: "AI가 고른 학습 자료·공공 제도 링크를 사용자가 직접 열어 봅니다. 링크는 정답이 아니라 검색 출발점이며, 건너뛸 수 있습니다." },
  { name: "영상 학습·이해 확인 (선택)", detail: "공개 YouTube 영상 주소를 넣으면 Gemini가 학습 질문을 만듭니다. 영상 학습 자체는 증거등급을 올리지 않습니다." },
  { name: "증서 발급 (선택)", detail: "조건을 채우면 학습 수료증·수행 확인서를 발급합니다. 무엇이 확인됐는지만 적고, 실력이나 취업 가능성은 말하지 않습니다." },
  ...
  { name: "삭제", detail: "“새 분석 시작하기”를 확인하면 입력·후보·선택·결과가 화면에서 모두 지워집니다. 서버에는 애초에 원문을 저장하지 않습니다. 회원이어도 결과를 서버에 쌓지 않습니다." },
];
