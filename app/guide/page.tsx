...
const STEPS = [
  {
    name: "1 · 시작",
    action: "데모 코드를 입력하고, 분석 동의 범위를 선택해요.",
    why: "데모 남용을 막고, 무엇에 동의하는지 먼저 확인하기 위해서예요.",
    time: "약 30초",
  },
  {
    name: "2 · 경험",
    action: "전공·학습·프로젝트·일·돌봄 경험을 자유롭게 적어요. (20자~10,000자)",
    ...
    >
      ...
      <section className="info-section">
        ...
        <ul>
          ...
          <li>세션이 만료되면 데모 코드 화면으로 돌아가요 — 입력한 내용은 그대로 남아 있어요.</li>
          <li>문제가 계속되면 새로고침 후 데모 코드를 다시 입력해 주세요.</li>
        </ul>
      </section>
    </InfoShell>
  );
