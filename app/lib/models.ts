...
export const SOLAR_MODELS: SolarModelOption[] = [
  ...
  },
  {
    ...
    badge: "안정형",
    officialNote: "검증 기간이 긴 고성능 모델입니다.",
    goodFor: "일반적인 길이의 경험 서술",
    relativeSpeed: "보통 (평가 중)",
    longText: "평가 중",
    evidenceExtraction: "평가 중",
    caution: "최신 기능 반영은 Pro 3보다 늦을 수 있습니다.",
  },
  {
    id: "solar-mini",
    label: "Mini",
    ...
    badge: "빠른 초안",
    officialNote: "가볍고 빠른 응답에 초점을 둔 모델입니다.",
    goodFor: "짧은 서술을 빠르게 훑어보고 싶을 때",
    relativeSpeed: "빠른 편 (공식 포지셔닝 기준)",
    longText: "긴 글에서는 후보를 놓칠 수 있습니다 (평가 중)",
    evidenceExtraction: "평가 중",
    caution: "복잡한 경험에서는 Pro 계열보다 단순한 결과가 나올 수 있습니다.",
  },
];
