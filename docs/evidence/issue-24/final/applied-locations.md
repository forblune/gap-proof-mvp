...
- ~~OG 1:1 중앙 크롭에서 좌상단 로고 부분 잘림~~ → **해소(PR #29 보완)**: 중앙 정렬 재배치로 필수 요소가 x315~885 안에 수납 — 1:1/4:3/16:9 크롭 검증 `og-crop-fix/crop-board.png`, 실측 `og-crop-fix/essential-bounds.json`
