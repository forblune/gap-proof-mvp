...
## 배포 기록 (2026-07-26 · 승인 배포 실행 완료)

| 항목 | 값 |
|---|---|
| PR #63 병합 | squash `c017772` (2026-07-26T00:49Z) + 핫픽스 `b8c79d5`(PR #65) |
| 배포 전 활성 버전(롤백 목표) | `cece759c-90c0-4788-99d6-6a8412cf59e1` |
| 1차 배포 | `175147d1-4b09-4aa5-883d-4638a36ff141` (00:52Z) — smoke 14/14 PASS·Solar 0회 |
| **실측 결함** | 실연결이 "응답을 받지 못해" 샘플 폴백 — max_tokens 2048 생성이 12s 타임아웃 초과 |
| 핫픽스 | 타임아웃 30s·max_tokens 1600·압축 출력(PR #65) |
| **최종 활성 버전** | `c856ee58-9637-4d55-b954-e9a5a37bf53c` (01:01Z, 100%) |
| 실 Solar 검증 | 성공 — 실연결 배지·모델 일치·V2 7필드 전부 렌더·인용 정합 (총 실호출 2회: 결함 발견 1 + 수정 검증 1 — 계획 1회 대비 +1, 사유 기록) |
| Secret·binding | 변경 0(기존 3종 그대로) · rollback 미수행 |
